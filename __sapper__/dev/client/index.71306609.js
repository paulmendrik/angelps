import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_each_argument, a as validate_slots, e as empty, b as insert_dev, c as detach_dev, n as noop, f as destroy_each, H as HtmlTag, g as element, t as text, h as space, j as create_component, k as claim_element, l as children, m as claim_text, o as claim_space, p as claim_component, q as attr_dev, r as add_location, u as append_dev, w as mount_component, x as set_data_dev, y as transition_in, z as transition_out, A as destroy_component, B as query_selector_all, C as check_outros, D as group_outros } from './client.7357a21f.js';
...
function create_each_block_1(ctx) {
	let div0;
	let h2;
	let t0_value = prismicDom_min.RichText.asText(/*item*/ ctx[5].data.title) + "";
	let t0;
	let t1;
	let div1;
	let prismichtml;
	...
	prismichtml = new PrismicHTML({
			props: { elements: /*item*/ ctx[5].data.content },
			$$inline: true
		});
	...
	const block = {
		...
		l: function claim(nodes) {
			div0 = claim_element(nodes, "DIV", { class: true, "uk-scrollspy": true });
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-h1m9zj");
			add_location(h2, file, 47, 0, 1187);
			attr_dev(div0, "class", "uk-width-1-4@m uk-margin-large-top");
			attr_dev(div0, "uk-scrollspy", "cls: uk-animation-slide-left; repeat: true");
			add_location(div0, file, 46, 0, 1080);
			attr_dev(div1, "class", "uk-width-3-4@m uk-margin-large-top");
			attr_dev(div1, "uk-scrollspy", "cls: uk-animation-slide-right; repeat: true");
			add_location(div1, file, 49, 0, 1249);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if ((!current || dirty & /*items*/ 1) && t0_value !== (t0_value = prismicDom_min.RichText.asText(/*item*/ ctx[5].data.title) + "")) set_data_dev(t0, t0_value);
			const prismichtml_changes = {};
			if (dirty & /*items*/ 1) prismichtml_changes.elements = /*item*/ ctx[5].data.content;
...
// (81:0) {#each testimonials as testimonial}
function create_each_block$1(ctx) {
	let li;
	let h4;
	let t0_value = prismicDom_min.RichText.asText(/*testimonial*/ ctx[2].data.title) + "";
	let t0;
	let t1;
	let prismichtml;
	let t2;
	...
	prismichtml = new PrismicHTML({
			props: {
				elements: /*testimonial*/ ctx[2].data.content
			},
			$$inline: true
		});
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			h4 = claim_element(li_nodes, "H4", {});
			var h4_nodes = children(h4);
			t0 = claim_text(h4_nodes, t0_value);
			h4_nodes.forEach(detach_dev);
			t1 = claim_space(li_nodes);
			claim_component(prismichtml.$$.fragment, li_nodes);
			t2 = claim_space(li_nodes);
			li_nodes.forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
			add_location(h4, file, 82, 0, 2347);
			add_location(li, file, 81, 0, 2342);
		},
		m: function mount(target, anchor) {
			...
			append_dev(h4, t0);
			append_dev(li, t1);
			mount_component(prismichtml, li, null);
			append_dev(li, t2);
			current = true;
		},
		p: function update(ctx, dirty) {
			if ((!current || dirty & /*testimonials*/ 2) && t0_value !== (t0_value = prismicDom_min.RichText.asText(/*testimonial*/ ctx[2].data.title) + "")) set_data_dev(t0, t0_value);
			const prismichtml_changes = {};
			if (dirty & /*testimonials*/ 2) prismichtml_changes.elements = /*testimonial*/ ctx[2].data.content;
			prismichtml.$set(prismichtml_changes);
		},
		i: function intro(local) {
			if (current) return;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(81:0) {#each testimonials as testimonial}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			ul0 = element("ul");
			li0 = element("li");
			t4 = text("Angel People Solutions Ltd");
			t5 = space();
			li1 = element("li");
			t6 = text("87 Old Wokingham Road");
			t7 = space();
			li2 = element("li");
			t8 = text("Crowthorne");
			t9 = space();
			...
			t14 = text("Tel: ");
			a0 = element("a");
			t15 = text("07876 648146");
			t16 = space();
			li6 = element("li");
			t17 = text("Email: ");
			a1 = element("a");
			t18 = text("jacqui@angelps.co.uk");
			t19 = space();
			li7 = element("li");
			a2 = element("a");
			span = element("span");
		...
		l: function claim(nodes) {
			const head_nodes = query_selector_all("[data-svelte=\"svelte-1fmc3jb\"]", document.head);
			head_nodes.forEach(detach_dev);
			t0 = claim_space(nodes);
			div3 = claim_element(nodes, "DIV", { class: true });
			var div3_nodes = children(div3);
			div2 = claim_element(div3_nodes, "DIV", { class: true, "uk-grid": true });
			...
			t21 = claim_text(h3_nodes, "Our Clients");
			h3_nodes.forEach(detach_dev);
			t22 = claim_space(div5_nodes);
			div4 = claim_element(div5_nodes, "DIV", { class: true, "uk-slideshow": true });
		...
		h: function hydrate() {
			document.title = "Angel People Solutions Ltd.";
			attr_dev(h2, "class", "svelte-h1m9zj");
			add_location(h2, file, 55, 0, 1525);
			attr_dev(div0, "class", "uk-width-1-4@m uk-margin-large-top");
			attr_dev(div0, "uk-scrollspy", "cls: uk-animation-slide-left; repeat: true");
			add_location(div0, file, 54, 0, 1418);
			attr_dev(li0, "class", "svelte-h1m9zj");
			add_location(li0, file, 59, 0, 1678);
			attr_dev(li1, "class", "svelte-h1m9zj");
			add_location(li1, file, 60, 0, 1714);
			attr_dev(li2, "class", "svelte-h1m9zj");
			add_location(li2, file, 61, 0, 1745);
			attr_dev(li3, "class", "svelte-h1m9zj");
			add_location(li3, file, 62, 0, 1765);
			attr_dev(li4, "class", "svelte-h1m9zj");
			add_location(li4, file, 63, 0, 1784);
			attr_dev(a0, "href", "tel:+447876648146");
			add_location(a0, file, 64, 9, 1811);
			attr_dev(li5, "class", "svelte-h1m9zj");
			add_location(li5, file, 64, 0, 1802);
			attr_dev(a1, "href", "mailto:jacqui@angelps.co.uk");
			add_location(a1, file, 65, 11, 1872);
			attr_dev(li6, "class", "svelte-h1m9zj");
			add_location(li6, file, 65, 0, 1861);
			attr_dev(span, "uk-icon", "icon: linkedin");
			attr_dev(span, "class", "svelte-h1m9zj");
			add_location(span, file, 66, 64, 2004);
			attr_dev(a2, "href", "https://uk.linkedin.com/in/jacqui-angel-48276b11");
			add_location(a2, file, 66, 4, 1944);
			attr_dev(li7, "class", "svelte-h1m9zj");
			add_location(li7, file, 66, 0, 1940);
			attr_dev(ul0, "class", "uk-list svelte-h1m9zj");
			add_location(ul0, file, 58, 0, 1657);
			attr_dev(div1, "class", "uk-width-3-4@m uk-margin-large-top");
			attr_dev(div1, "uk-scrollspy", "cls: uk-animation-slide-right; repeat: true");
			add_location(div1, file, 57, 0, 1549);
			attr_dev(div2, "class", "uk-grid-column-small uk-grid-row-large");
			attr_dev(div2, "uk-grid", "");
			add_location(div2, file, 44, 0, 997);
			attr_dev(div3, "class", "uk-container uk-margin-large-top");
			add_location(div3, file, 41, 0, 948);
			attr_dev(h3, "class", "svelte-h1m9zj");
			add_location(h3, file, 77, 0, 2177);
			attr_dev(ul1, "class", "uk-slideshow-items svelte-h1m9zj");
			add_location(ul1, file, 79, 0, 2274);
			attr_dev(div4, "class", "uk-slideshow svelte-h1m9zj");
			attr_dev(div4, "uk-slideshow", "autoplay: true; animation: slide");
			add_location(div4, file, 78, 0, 2198);
			attr_dev(div5, "class", "uk-width-1-1@m");
			add_location(div5, file, 76, 0, 2147);
			attr_dev(div6, "class", "uk-container");
			add_location(div6, file, 75, 0, 2120);
			attr_dev(div7, "class", "uk-section testimonials svelte-h1m9zj");
			add_location(div7, file, 74, 0, 2082);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*testimonials, PrismicDOM*/ 2) {
...
async function preload({ params, query }) {
	const contentResponse = await Client.query(index.Predicates.at("document.type", "content"), { orderings: "[my.content.date]" });
	const testimonialResponse = await Client.query(index.Predicates.at("document.type", "testimonial"));
...
function instance$1($$self, $$props, $$invalidate) {
	...
	const writable_props = ["items", "testimonials"];
...
class Routes extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { items: 0, testimonials: 1 });
		...
		if (/*testimonials*/ ctx[1] === undefined && !("testimonials" in props)) {
			console.warn("<Routes> was created without expected prop 'testimonials'");
		}
	}
